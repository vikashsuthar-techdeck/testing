					...
					<div class="row">
						<div class="col-sm-6 animate" data-anim-type="fadeInUp" data-anim-delay="300">
							<div class="text-box">
								...
								<a href="restaurant.php#" class="btn btn-default">Book Now</a>
							</div>
						</div>
				...
				<div class="container-fluid">
					<div class="row">
							...
							<div class="image-frame">
								<div class="info-frame"> 
									...
									<ul class="list-inline social-networks">
										<li><a href="restaurant.php#"><span class="icon-facebook"></span></a></li>
										<li><a href="restaurant.php#"><span class="icon-twitter"></span></a></li>
										<li><a href="restaurant.php#"><span class="icon-youtube"></span></a></li>
										<li><a href="restaurant.php#"><span class="icon-instagram"></span></a></li>
										<li><a href="restaurant.php#"><span class="icon-google"></span></a></li>
									</ul>
								</div>
						...
						<article class="col-md-3 col-xs-6">
							<div class="image-frame">
								<div class="info-frame">
									<a href="restaurant.php#" class="magnify"></a>
									<ul class="list-inline social-networks">
										<li><a href="restaurant.php#"><span class="icon-facebook"></span></a></li>
										<li><a href="restaurant.php#"><span class="icon-twitter"></span></a></li>
										<li><a href="restaurant.php#"><span class="icon-youtube"></span></a></li>
							...
							<div class="item active">
									...
									<ul class="list-unstyled menu-list">
										<li>
											<a href="restaurant.php#">
												<div class="image-frame"><img src="images/img-01.jpg" alt="image description"></div>
												<div class="text">
										...
										<li>
											<a href="restaurant.php#">
												<div class="image-frame"><img src="images/img-02.jpg" alt="image description"></div>
												<div class="text">
													<h2>Wellfleet oysters</h2>
													<p>Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.</p>
												</div>
										...
										<li>
											<a href="restaurant.php#">
												<div class="image-frame"><img src="images/img-03.jpg" alt="image description"></div>
												<div class="text">
													<h2>Wellfleet oysters</h2>
													<p>Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.</p>
												</div>
								...
								<div class="col-sm-6">
									<ul class="list-unstyled menu-list">
										<li>
											<a href="restaurant.php#">
												<div class="image-frame"><img src="images/img-04.jpg" alt="image description"></div>
												<div class="text">
													<h2>Wellfleet oysters</h2>
													<p>Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.</p>
												</div>
										...
										<li>
											<a href="restaurant.php#">
												<div class="image-frame"><img src="images/img-05.jpg" alt="image description"></div>
												<div class="text">
													<h2>Wellfleet oysters</h2>
													<p>Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.</p>
												</div>
										...
										<li>
											<a href="restaurant.php#">
												<div class="image-frame"><img src="images/img-06.jpg" alt="image description"></div>
												<div class="text">
													<h2>Wellfleet oysters</h2>
													<p>Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.</p>
												</div>
		...
		<div class="b-container">
			<div class="footer-nav">
				<div class="container">
					<div class="row">
						<div class="col-xs-12">
							<a href="restaurant.php#wrapper" class="go-top">
			...
			<footer id="footer">
				<div class="container">
					<div class="row">
						<div class="col-sm-6">
							<p>&copy; <a href="restaurant.php#" class="link">RangeRelaxe</a>. All rights reserved. Design by <a href="restaurant.php#">GalliaSoft</a></p>
						</div>
						<div class="col-sm-6">
							<ul class="list-inline social-networks">
								<li><a href="restaurant.php#"><span class="icon-facebook"></span></a></li>
