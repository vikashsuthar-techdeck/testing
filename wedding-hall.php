...
<body>
	...
	<div id="wrapper">
						...
						<nav class="navbar navbar-default"> 
							...
							<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
								...
								<ul class="nav navbar-nav navbar-right">
									<li class="active"><a href="wedding-hall.php">wedding hall</a></li>
		...
		<!-- banner -->
		<div class="banner"><img src="images/banner3.jpg" alt="banner"></div>
		<!-- Navigation -->
		...
		<main id="main">
			...
			<section class="services-block">
				<div class="image-frame" style="background-image: url('images/image-16.jpg');"></div>
					...
					<div class="row">
						<div class="col-md-6 col-sm-12 pull-right">
							<div class="row">
								...
								<div class="col-sm-6 col-md-12 col-lg-6 block drinks">
									<h2>free drinks</h2>
									<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
								</div>
				...
				<div class="row">
						...
						<div class="image-frame">
							<div class="info-frame">
								...
								<ul class="list-inline social-networks">
									<li><a href="wedding-hall.php#"><span class="icon-facebook"></span></a></li>
									<li><a href="wedding-hall.php#"><span class="icon-twitter"></span></a></li>
									<li><a href="wedding-hall.php#"><span class="icon-youtube"></span></a></li>
									<li><a href="wedding-hall.php#"><span class="icon-instagram"></span></a></li>
									<li><a href="wedding-hall.php#"><span class="icon-google"></span></a></li>
								</ul>
							</div>
							<img src="images/image-17.jpg" alt="image description">
						</div>
						<div class="info-bar">
							<div class="holder">
								<div class="col">
								...
								<div class="col">
									<strong class="price"><span>$650</span> 200 people</strong>
								</div>
							</div>
						</div>
					</article>
					<article class="col-sm-4 info-block animate" data-anim-type="fadeInUp" data-anim-delay="600">
						<div class="image-frame">
							...
							<img src="images/image-18.jpg" alt="image description">
						</div>
						<div class="info-bar">
							<div class="holder">
								<div class="col">
								...
								<div class="col">
									<strong class="price"><span>$1000</span> 200 people</strong>
								</div>
							</div>
						</div>
					</article>
					<article class="col-sm-4 info-block animate" data-anim-type="fadeInUp" data-anim-delay="900">
						<div class="image-frame">
							...
							<img src="images/image-19.jpg" alt="image description">
						</div>
						<div class="info-bar">
							<div class="holder">
								<div class="col">
								...
								<div class="col">
									<strong class="price"><span>$1750</span> 500 people</strong>
								</div>
							</div>
						</div>
					</article>
						...
						<div class="col-xs-12">
							<div class="counter-list horizon" data-animate-in="scale:1.2;">
								...
								<div class="grid-item">
									<div class="counter-wrapper">
										<strong class="number counter">
											<span id="s2" class="stats" data-count-from="100" data-count-to="2512" >2512</span>
										</strong>
										...
										<div class="col-sm-4 col">
											<div class="image-frame">
												<div class="image-holder">
													<img src="images/thumb-14.jpg" alt="image description">
												</div>
											</div>
										</div>
									</div>
								...
								<div class="col-xs-6">
									<div class="row">
										...
										<div class="col-sm-4 col">
											<div class="image-frame">
												<div class="image-holder">
													<img src="images/thumb-15.jpg" alt="image description">
												</div>
											</div>
										</div>
									</div>
		...
		<div class="b-container">
			<div class="footer-nav">
				<div class="container">
					<div class="row">
						<div class="col-xs-12">
							<a href="wedding-hall.php#wrapper" class="go-top">
			...
			<footer id="footer">
				<div class="container">
					<div class="row">
						<div class="col-sm-6">
							<p>&copy; <a href="wedding-hall.php#" class="link">RangeRelaxe</a>. All rights reserved. Design by <a href="wedding-hall.php#">GalliaSoft</a></p>
						</div>
						<div class="col-sm-6">
							<ul class="list-inline social-networks">
								<li><a href="wedding-hall.php#"><span class="icon-facebook"></span></a></li>
