				...
				<div class="row">
					<div class="col-xs-7">
						<ol class="breadcrumb">
							...
							<li class="active">Deluxe Room Detail</li>
						</ol>
					</div>
					<!-- <div class="col-xs-5">
						...
						<div id="flex-slider" class="flexslider">
							<ul class="slides">
								<li>
									...
									<img src="<?php  $val=data(1,'room_details'); echo $val['2']; ?>" alt="image description">
								</li>
								<li>
									<!-- <div class="information-box">
										<a class="fancybox magnify" href="images/img13.jpg"></a>
									...
									<img src="<?php  $val=data(2,'room_details'); echo $val['2']; ?>" alt="image description">
								</li>
								<li>
									<!-- <div class="information-box">
										<a class="fancybox magnify" href="images/img13.jpg"></a>
									...
									<img src="<?php  $val=data(3,'room_details'); echo $val['2']; ?>" alt="image description">
								</li>
							</ul>
						</div>
						<div id="thumbnails" class="flexslider">
							<ul class="slides">
								<li> <img src="<?php  $val=data(1,'room_details'); echo $val['2']; ?>" alt="image description"> </li>
								<li> <img src="<?php  $val=data(2,'room_details'); echo $val['2']; ?>" alt="image description"> </li>
								<li> <img src="<?php  $val=data(3,'room_details'); echo $val['2']; ?>" alt="image description"> </li>
							</ul>
						</div>
					</div>	
					<div class="col-sm-6 info-frame">
						<h1>deluxe room</h1>
						<p><?php  $val=data(1,'room_details'); echo $val['1']; ?></p>
						<ul class="detail-list list-unstyled">
							<li><strong>Bed:</strong><?php  $val=data(1,'rooms'); echo $val['2']; ?></li>
							<li><strong>Max:</strong><?php  echo $val['3']; ?></li>
							<li><strong>Availability:</strong> <?php  $val=data(1,'room_details'); echo $val['3']; ?></li>
							<li><strong>Room size:</strong><?php  $val=data(1,'rooms'); echo $val['4']; ?></li>
						</ul>
			...
			<article class="description-block container b-padding">
				<div class="row">
					<div class="col-md-3 col-sm-4">
						<h1>Description</h1>
						<p><?php  $val=data(4,'room_details'); echo $val['1']; ?></p>
					</div>
					<div class="col-md-9 col-sm-8">
						<div class="image-frame">
							<h1>Description</h1>
							<img src="<?php  $val=data(4,'room_details'); echo $val['2']; ?>" alt="image description">
						</div>
					</div>
				</div>
			</article>
